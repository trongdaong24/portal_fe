<template>
  <q-page class="ub-page">
    <div class="row items-center">
      <div class="col-md-12 q-ma-sm">
        ...
        <div class="text-subtitle1">
          <a href="https://quasar.dev/vue-components/table" target="_blank"
            >https://quasar.dev/vue-components/table</a
          >
        </div>
      </div>
    </div>
    ...
    <div class="row items-center" style="margin-top: 20px;">
      <div class="col-md-12 q-ma-sm">
        <div class="text-h5">
          Advanced Table: Filtering, Pagination, Sorting, Preview, Full Screen,
          Click on Row
        </div>
        <h-table
          :hits="hitsTableData"
          :display-fields="hitsDisplayFields"
