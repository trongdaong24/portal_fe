...
export default {
  ...
  methods: {
    initialize: function() {
      ...
      this.dbdata.setWData("w20", {
        data: { labels: [], datasets: [{ data: [] }] }
      });
      this.dbdata.setWData("w21", {
        data: { labels: [], datasets: [{ data: [] }] }
      });
      this.dbdata.setWData("w22", {
        data: { labels: [], datasets: [{ data: [] }] }
      });
    ...
    updateStats: function() {
      ...
      let codesData = utils.getKVObjSortedArray(
        pathOr({}, ["statuscode"], errorsData),
        false
      );
      ...
      let topNotFound = utils.getKVObjSortedArray(
        pathOr({}, ["topnotfound"], errorsData),
        false
      );
      ...
      let topServerError = utils.getKVObjSortedArray(
        pathOr({}, ["topservererror"], errorsData),
        false
      );
